...
namespace DatabaseLayer
{
    ...
    public partial class OnlineDiagnosticLabSystemDbEntities : DbContext
    {
        public OnlineDiagnosticLabSystemDbEntities()
            : base("name=OnlineDiagnosticLabSystemDbEntities")
        {
        }
